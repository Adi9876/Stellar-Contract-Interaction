...
function parseTransactionInfo(raw) {
  var _raw$events$diagnosti, _raw$events, _raw$events$contractE, _raw$events2, _raw$events$transacti, _raw$events3;
  ...
  var info = {
    ...
    resultMetaXdr: meta,
    events: {
      diagnosticEventsXdr: (_raw$events$diagnosti = (_raw$events = raw.events) === null || _raw$events === void 0 ? void 0 : _raw$events.diagnosticEventsXdr.map(function (e) {
      ...
      transactionEventsXdr: (_raw$events$transacti = (_raw$events3 = raw.events) === null || _raw$events3 === void 0 ? void 0 : _raw$events3.transactionEventsXdr.map(function (e) {
...
function parseRawEvents(raw) {
  ...
  return {
    ...
    cursor: raw.cursor,
    events: ((_raw$events4 = raw.events) !== null && _raw$events4 !== void 0 ? _raw$events4 : []).map(function (evt) {
